...
import com.example.arafat.arafatdemo.dialog.CustomDialog;
...
/**
 * Created by Arafat on 2/13/2017.
 */
...
public class DialogActivity extends BaseActivity {
    ...
    private void customDialog() {
        final CustomDialog dialog
                = new CustomDialog(this, new CustomDialog.ICustomDialogEventListener() {
        @Override
